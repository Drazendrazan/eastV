...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 7) -- Gets max players from config file, default 48
QBConfig.DefaultSpawn = vector4(-206.78678894043, -1014.8986206055, 30.13809967041, 47.798393249512)
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 250, bank = 1000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Server.ClosedReason = "Sunucu Bakımda ! " -- Reason message to display when people can't join the server
...
QBConfig.Server.Discord = "https://discord.gg/eastv" -- Discord invite link
