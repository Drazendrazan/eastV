Locales = {
    ...
    ['tr'] = {
        ...
        ['truck'] = "Truck",
        -- DISPATCH MESSAGES
        ['vehicleshots'] = "Araç içinden silahlı saldırı!",
        ['shooting'] = "Ateşli silahlı saldırı!",
        ['melee'] = "Fight in progress",
        ['driveby'] = "Araç içinden silahlı saldırı!",
        ...
        ['carjacking'] = "Çalıntı Araç", 
        ['vehicletheft'] = "Vehicle Theft", 
        ['officerdown'] = "Officer düştü!",
        ['emsdown'] = "EMS Düştü!",
