...
Config = {}
Config.blipName = "Contractor Co."
Config.jobrequirement = false 
Config.jobname = 'builder' 
...
Config.builder = {
	['BossSpawn'] = { 
		Pos = {x = -247.37, y = -962.36, z = 31.22, h = 261.95}, 
		Type  = 'csb_reporter', 
	}
}
...
Config.Places1lvl = {
    [1] = {
        Pos = {x = -91.56, y = -1030.82, z = 27.87, h = 6.10}, 
		Type  = 's_m_y_construct_02', 
        Places = {
            {
                Pos = {x = -110.26, y = -1026.15, z = 27.27, h = 345.23}, 
                Done = false, 
                WorkingTime = 2500, 
                Tool = 'weld', 
                blip, 
...
Config.Places2lvl = {
    [1] = {
        Pos = {x = 141.09, y = -379.73, z = 43.26, h = 45.53}, 
        VehiclePos = {x = 136.45, y = -377.96, z = 43.07, h = 339.15}, 
		Type  = 's_m_y_construct_02', --model ped
        Vehicle = 'burrito', --model vehicle
        PlaceLoad = {x = 2677.49, y = 3513.01, z = 52.71, h = 140.84}, 
        PlaceUnLoad = {x = 101.17, y = -394.56, z = 41.26, h = 61.10}, 
    },
    [2] = {
...
Config.Places3lvl = {
    [1] = {
        Pos = {x = -1959.85, y = 212.93, z = 86.51, h = 272.07}, 
		Type  = 'a_f_m_bevhills_01', 
        Places = {
            {
                Pos = {x = -1971.59, y = 185.98, z = 86.58, h = 26.70}, 
                Done = false,
                WorkingTime = 2500, 
                Tool = 'hammer',
                blip,
