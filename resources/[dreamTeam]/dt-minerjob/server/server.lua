...
RegisterServerEvent('dreamTeam-miner:mine')
AddEventHandler('dreamTeam-miner:mine', function(Pickaxe, Level)
...
QBCore.Functions.CreateCallback('dreamTeam-miner:upgrade', function(source, cb, pickaxe)
    local xPlayer = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('dreamTeam-miner:payout', function(source, cb, exp)
    local xPlayer = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('dreamTeam-miner:getdatabase', function(source, cb, xPlayer)
    local xPlayer = QBCore.Functions.GetPlayer(source)
