...
Config.Options = {
    ...
    ['time_finished'] = 'Kiralama süreniz doldu, teşekkürler.',
    ['spawnpoint_blocked'] = 'Başka bir araç garaj çıkışında.',  -- message when spawn_point is blocked by other vehicle.
    ['no_money'] = 'Aracı kiralamak için yeterli paranız yok.', -- message when don't have money.
    ['return_success'] = 'Aracı başarıyla iade ettin, teşekkürler!', -- message when return the vehicle is Successfully.
    ['return_error'] = 'Kiraladığınız araçta olmanız gerekmektedir.', -- message when the player its not in rented vehicle.
    ['cant_rent'] = 'Zaten bir araç kiraladınız', -- message when the player already have a rented vehicle.
}
    ...
    ['lossantosavenue'] = { -- name of the location, you can put whatever you like.
        ...
        markers = {
            spawn = {
                ...
                text = '[ ~g~E~w~ ] Araç Kirala', -- text of marker.
                text = '[ ~g~E~w~ ] Araç Kirala' -- text of marker.
            },
            return_spot = {
        ...
        blips = {
            spawn = {
                name = 'Araç Kirala', -- name of the blip in map.
                sprite = 523, -- sprite of the blip.
                scale = 0.8, -- scale of the.
                color = 2 -- color of the. 
            },
            return_spot = {
                name = 'Aracı teslim et', -- name of the return blip in map.
