Artgalleryheist = {}
Artgalleryheist.Functions = {}

Artgalleryheist.Functions.OpenPinpad = function() {
    $(".container").fadeIn(300);
}

Artgalleryheist.Functions.ClosePinpad = function() {
    $(".container").fadeOut(300);
    $.post('https://qb-artgalleryheist/PinpadClose');
}

$(document).on('keydown', function() {
    switch(event.keyCode) {
        case 27:
            Artgalleryheist.Functions.ClosePinpad();
            break;
        case 49:
            Artgalleryheist.Functions.AddNumber(1);
            break;
        case 50:
            Artgalleryheist.Functions.AddNumber(2);
            break;
        case 51:
            Artgalleryheist.Functions.AddNumber(3);
            break;
        case 52:
            Artgalleryheist.Functions.AddNumber(4);
            break;
        case 53:
            Artgalleryheist.Functions.AddNumber(5);
            break;
        case 54:
            Artgalleryheist.Functions.AddNumber(6);
            break;
        case 55:
            Artgalleryheist.Functions.AddNumber(7);
            break;
        case 56:
            Artgalleryheist.Functions.AddNumber(8);
            break;
        case 57:
            Artgalleryheist.Functions.AddNumber(9);
            break;
        case 48:
            Artgalleryheist.Functions.AddNumber(0);
            break;
        case 13:
            var v = $("#PINbox").val();
            if (v == "") {
                $.post('https://qb-artgalleryheist/ErrorMessage', JSON.stringify({
                ...
                $("#PINbox").val("");
                $.post('https://qb-artgalleryheist/EnterPincode', JSON.stringify({
                    pin: data.pin
                }))
                Artgalleryheist.Functions.ClosePinpad();
            };
...
$(document).ready(function(){
    window.addEventListener('message', function(event){
        switch(event.data.action) {
            case "open":
                Artgalleryheist.Functions.OpenPinpad(event.data);
                break;
            case "close":
                Artgalleryheist.Functions.ClosePinpad(event.data);
                break;
        }
    });
});
...
Artgalleryheist.Functions.AddNumber = function(num) {
	var v = $("#PINbox").val();
	$("#PINbox").val(v + num);
}
