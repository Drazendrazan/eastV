  ...
  window.addEventListener("message", function (event) {
    ...
    if (data.action == "ui") {
      ...
      if (data.toggle) {
        ...
        var originalText = "Oyuncu verileri yükleniyor.";
        ...
        var DotsInterval = setInterval(function () {
          ...
          if (loadingProgress == 4) {
            originalText = "Oyuncu Yükleniyor";
            $("#loading-text").html(originalText);
          }
          if (loadingProgress == 6) {
            originalText = "Karakter doğrulanıyor";
            $("#loading-text").html(originalText);
          }
          if (loadingDots == 4) {
            $("#loading-text").html(originalText);
...
$(document).on("click", ".character", function (e) {
  ...
  if (selectedChar === null) {
    ...
    if (selectedChar.data("cid") == "") {
      ...
      $("#play-text").html("Oyna");
      $("#delete-text").html("");
      $("#play").css({ display: "block" }, { color: "black" });
...
function setCharactersList() {
  var htmlResult =
    '<div class="character-list-header"><p>Karakterlerim</p></div>';
  for (let i = 1; i <= NChar; i++) {
    htmlResult +=
      '<div class="character" id="char-' +
      i +
      '" data-cid=""><span id="slot-name">Yeni Karakter<span id="cid"></span></span></div>';
  }
  htmlResult +=
    '<div class="character-btn" id="play"><p id="play-text"></p></div><div class="character-btn" id="delete"><p id="delete-text"></p></div>';
