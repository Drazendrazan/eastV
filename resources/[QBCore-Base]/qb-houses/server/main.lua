...
QBCore.Commands.Add("dekorasyon", "Evini dekore et", {}, false, function(source)
    local src = source
    TriggerClientEvent("qb-houses:client:decorate", src)
end)

QBCore.Commands.Add("evyap", "Ev Oluştur", {{name = "price", help = "Fiyatı"}, {name = "tier", help = "Seviyesi"}}, true, function(source, args)
    local src = source
    ...
    if Player.PlayerData.job.name == "realestate" then
        ...
        TriggerClientEvent('QBCore:Notify', src, "Sadece emlakcılar bunu yapabilir", "error")
    end
end)

QBCore.Commands.Add("garage", "Evine garaj ekle (sadece emlakcılara özel)", {}, false, function(source)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.PlayerData.job.name == "realestate" then
...
QBCore.Commands.Add("egir", "Eve gir", {}, false, function(source)
    local src = source
    TriggerClientEvent('qb-houses:client:EnterHouse', src)
end)

QBCore.Commands.Add("zil", "Zili Çal", {}, false, function(source)
    local src = source
