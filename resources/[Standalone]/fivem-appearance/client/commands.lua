...
RegisterCommand("şapka", function(source, args, rawCommand)
    TriggerEvent('hat')
end, false)

RegisterCommand("eldiven", function(source, args, rawCommand)
    TriggerEvent('handske')
end, false)

RegisterCommand("gözlük", function(source, args, rawCommand)
    TriggerEvent('briller')
end, false)

RegisterCommand("kıravat", function(source, args, rawCommand)
    TriggerEvent('hals')
end, false)

RegisterCommand("zırh", function(source, args, rawCommand)
    TriggerEvent('vest')
end, false)

RegisterCommand("çanta", function(source, args, rawCommand)
    TriggerEvent('ryg')
end, false)

RegisterCommand("sağkol", function(source, args, rawCommand)
    TriggerEvent('harm')
end, false)

RegisterCommand("solkol", function(source, args, rawCommand)
    TriggerEvent('varm')
end, false)

RegisterCommand("kulak", function(source, args, rawCommand)
    TriggerEvent('ear')
end, false)

RegisterCommand("ayakkabı", function(source, args, rawCommand)
    TriggerEvent('sko')
end, false)
...
RegisterCommand("ceket", function(source, args, rawCommand)
    TriggerEvent('shirtF')
end, false)

RegisterCommand("pantolon", function(source, args, rawCommand)
