...
doc.getElementById('favorite').addEventListener('mouseover', _ => changeInfo(true, 'favorites', 'Favori animasyonların.'));
...
doc.getElementById('dances').addEventListener('mouseover', _ => changeInfo(true, 'dances', 'Dans animasyonları.'));
...
doc.getElementById('props').addEventListener('mouseover', _ => changeInfo(true, 'props', 'Prop animasyonları.'));
...
doc.getElementById('scenarios').addEventListener('mouseover', _ => changeInfo(true, 'scenarios', 'Senaryolu animasyonlar.'));
...
doc.getElementById('walks').addEventListener('mouseover', _ => changeInfo(true, 'walks', 'Yürüyüş animasyonları.'));
...
doc.getElementById('expressions').addEventListener('mouseover', _ => changeInfo(true, 'expressions', 'Yüz animasyonları.'));
...
doc.getElementById('shared').addEventListener('mouseover', _ => changeInfo(true, 'shared', 'Paylaşılabilir animasyonlar.'));
...
doc.getElementById('cancel').addEventListener('mouseover', _ => changeInfo(true, 'Cancel', 'Animasyon İptal'));
...
doc.getElementById('delete').addEventListener('mouseover', _ => changeInfo(true, 'Propları Sil', 'Prop bugını kaldırır.'));
...
doc.getElementById('movement').addEventListener('mouseover', _ => changeInfo(true, 'Yürümek', 'Paylaşılanlar hariç her animasyonda yürüyebilirsin.'));
...
doc.getElementById('loop').addEventListener('mouseover', _ => changeInfo(true, 'Tekrar', 'Animasyonları tekrar eder.'));
